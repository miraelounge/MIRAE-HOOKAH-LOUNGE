...
const appCss = "/MIRAE-HOOKAH-LOUNGE/assets/styles-B8VLqWgH.css";
function Nav() {
  ...
  return /* @__PURE__ */ jsx("header", { className: `nav-header ${scrolled ? "nav-header-scrolled" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "container-max py-5 flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxs("nav", { className: "hidden md-flex items-center gap-10 text-[0.7rem] font-display uppercase tracking-[0.32em] nav-links", children: [
      /* @__PURE__ */ jsx("a", { href: `${"/MIRAE-HOOKAH-LOUNGE/"}#karte`, children: "Die Karte" }),
      /* @__PURE__ */ jsx("a", { href: `${"/MIRAE-HOOKAH-LOUNGE/"}#atmosphaere`, children: "Atmosphäre" }),
      /* @__PURE__ */ jsx("a", { href: `${"/MIRAE-HOOKAH-LOUNGE/"}#galerie`, children: "Galerie" }),
      /* @__PURE__ */ jsx("a", { href: `${"/MIRAE-HOOKAH-LOUNGE/"}#location`, children: "Location" })
    ] }),
    /* @__PURE__ */ jsx(
      "a",
      {
...
const $$splitComponentImporter = () => import("./index-D5WjGKnF.js");
