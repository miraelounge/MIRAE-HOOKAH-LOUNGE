...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BoI9PRch.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-v2tCmHx4.js").then((n) => n.r),
    import("./start-CjWEnv7x.js"),
...
var ROUTER_BASEPATH = "MIRAE-HOOKAH-LOUNGE";
var SERVER_FN_BASE = "/MIRAE-HOOKAH-LOUNGE/_serverFn/";
